      ...
      <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          </div>
          {
            openDropDown && (
              <div className="w-[250px] h-max shadow-2xl z-50 bg-white fixed top-16 left-60 border-2 p-5 border-gray-100 rounded-md">
                <h1 className="font-semibold mb-4 text-xl flex justify-between">Change Location <span><CgClose onClick={()=>{setOpenDropDown(false)}} /></span> </h1>
                <button onClick={getLocation} className="bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer">Detect my Location</button>
              </div>
            )
          }
        </div>
        ...
        <nav className="flex gap-7 items-center">
          ...
          <Link to="/cart" className="relative">
            ...
            <span className="bg-red-500 px-2  rounded-full absolute -top-3 -right-4 text-white">
              0
            </span>
          </Link>
          <div>
